...
This library contains the functionality to find customers who are likely to churn.
With clean code principles this module holds the optimization, engineering and software best practices.
This is the refactor virsion of the given churn_notebook.ipynb.
